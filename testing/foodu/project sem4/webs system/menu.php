...
<body>
  <div class="position-fixed w-100" id="nav">
    <div class="head">
      <h1 class="text-center text-white p-2" id="gg">Menu</h1>

      <div class="container ">
        <div class="input-group d-flex justify-content-left">
          <div class="form-outline ">
            <input id="search-input" type="search" id="form1" placeholder="Search" class="form-control" onkeyup="ajax(this.value)" autocomplete="on" />
          ...
          <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal" id="card">
            ...
            <p class="text-white position-absolute " style="font-weight: 200;transform: translate(25px,-25px);font-size: 20px;" id='no'>0</p>
