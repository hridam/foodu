...
#icon {
  ...
  <div id="formContent">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="admin.php">Login</a>
    </div>
...
$s = "SELECT * from admin_login where User_Name = '$a'";
...
if($num == 1){
    ...
    $ref = "INSERT INTO admin_login (User_Name, Email, Password) VALUES('$a', '$b', '$c')";
